...
export default function FreelancerShow({ freelancer, authUser }) {
    ...
    const roleLabel = freelancer?.roles?.[0]?.name
        ? freelancer.roles[0].name.charAt(0).toUpperCase() +
          freelancer.roles[0].name.slice(1)
        : "Freelancer";
                ...
                <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="text-gray-500 mt-2 max-w-2xl">
                            A complete profile page for freelancers, including
                            service highlights, biography, top gigs, and contact
                            actions.
                        </p>
                    </div>
                    {hasChatAccess && (
                        <Link
                            href={route("chat.with-user", freelancer.uuid)}
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div className="mt-6">
                                ...
                                <p className="text-gray-600 mt-3 leading-7 whitespace-pre-line">
                                    {freelancer?.bio ||
                                        "This freelancer has not added a bio yet. A great freelancer profile helps clients understand skills, expertise, and service quality."}
                                </p>
                            </div>
                    ...
                    <aside className="space-y-6">
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6">
                            ...
                            <p className="text-gray-600">
                                Want to discuss a project, ask about
                                availability, or request a custom offer? Start a
                                conversation now.
                            </p>
                            {hasChatAccess && (
                                <Link
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div className="space-y-3">
                                <Link
                                    href="/chat"
                                    className="block px-4 py-3 rounded-2xl bg-cream-50 border border-gray-200 text-gray-700 hover:border-brand-200 transition-colors"
                                >
                                    Open chat inbox
                                </Link>
                                <Link
