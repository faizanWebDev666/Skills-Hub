            ...
            case 'refund':
                return (
                    <svg className="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 21l-4-4 4-4" />
                    </svg>
                );
            default:
                return (
                    ...
                    <div className="px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="mb-8">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-2 text-gray-600">View and filter all your wallet transactions</p>
                                </div>
                                <Link
                                    href="/wallet"
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 mb-6">
                            ...
                            {(filters.type || filters.status || filters.start_date || filters.end_date) && (
                                <div className="mt-4">
                                    <button
                                        onClick={() => router.get('/wallet/transactions', {}, { preserveState: true })}
                                            ...
                                            <tbody className="divide-y divide-gray-200">
                                                {transactions.data.map((transaction) => (
                                                    <tr key={transaction.id} className="hover:bg-gray-50">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full capitalize ${getStatusBadge(transaction.status)}`}>
                                                                {transaction.status}
                                                            </span>
                                                        </td>
