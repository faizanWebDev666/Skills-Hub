                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 xl:col-span-8 w-full">
                        ...
                        >
                            {gig.image ? (
                                ...
                                <div className="w-full h-full bg-gradient-to-br from-brand-50 to-brand-100 flex items-center justify-center">
                                    <span className="text-brand-300 font-bold text-4xl">
                                        No Image
                                    </span>
                                </div>
                            )}
                        ...
                        <div className="flex gap-8 mb-8 border-b border-gray-200 sticky top-20 bg-[#FAFAFA]/90 backdrop-blur-xl z-20 pt-4">
                            {["overview", "about the seller", "reviews"].map(
                                (tab) => (
                                    <button
                                        key={tab}
                            ...
                            <AnimatePresence mode="wait">
                                {activeTab === "overview" && (
                                    ...
                                    >
                                        ...
                                        {gig.category_fields &&
                                            Object.keys(gig.category_fields)
                                                .length > 0 && (
                                                <motion.div
                                                    initial={{
                                                        opacity: 0,
                                                                            ...
                                                                            {value.map(
                                                                                (
                                                                                    ...
                                                                                    <span
                                                                                        ...
                                                                                        className="px-3 py-1.5 bg-white border border-gray-200 text-gray-700 rounded-lg text-sm font-semibold shadow-xs"
                                                                                    >
                                                                                        {
                                                                                            item
                                                                                        }
                                        ...
                                        <div className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-start">
                                            ...
                                            <div className="flex-1 w-full">
                                                ...
                                                <p className="text-gray-600 leading-relaxed mb-6 font-medium">
                                                    {gig.user?.bio ||
                                                        "Passionate about delivering high-quality work and helping clients achieve their business goals."}
                                                </p>
                                                                ...
                                                                <button
                                                                    ...
                                                                    title={
                                                                        isOwner
                                                                            ...
                                                                            : "Vendors cannot contact sellers"
                                                                    }
                                                                >
                                        ...
                                        {reviews && reviews.length > 0 ? (
                                            <div className="grid gap-6">
                                                {reviews.map((review) => (
                                                    <div
                                                        key={review.id}
                                                        className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm transition-shadow hover:shadow-md"
                                                    >
                                                                ...
                                                                {[
                                                                    ...
                                                                    (_, i) => (
                                                                        <Star
                                                                            ...
                                                                            className={`w-4 h-4 ${i < review.rating ? "fill-amber-400" : "text-gray-300"}`}
                                                                        />
                                                                    ),
                                                                )}
                                                            </div>
                            ...
                            <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-200 p-6 md:p-8 relative overflow-hidden group">
                                ...
                                <div className="pt-2">
                                    ...
                                    <p className="text-gray-600 font-medium leading-relaxed mb-6 text-sm">
                                        Get professional, high-quality service
                                        tailored to your needs by a verified
                                        expert.
                                    </p>
