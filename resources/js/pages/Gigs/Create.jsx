...
const categories = [
    {
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., Full Stack Developer' },
            { name: 'programming_languages', label: 'Programming Languages', type: 'tags', placeholder: 'Add programming languages...', suggestions: ['JavaScript', 'TypeScript', 'Python', 'Java', 'PHP', 'Go', 'Rust', 'Swift', 'Kotlin', 'C#', 'C++'] },
            { name: 'frameworks', label: 'Frameworks', type: 'tags', placeholder: 'Add frameworks...', suggestions: ['Laravel', 'React', 'Vue', 'Angular', 'Node.js', 'Express', 'Next.js', 'Nuxt.js', 'Django', 'Flask', 'Spring Boot'] },
            { name: 'databases', label: 'Databases', type: 'tags', placeholder: 'Add databases...', suggestions: ['MySQL', 'PostgreSQL', 'MongoDB', 'SQLite', 'Redis', 'Oracle', 'SQL Server', 'Firebase'] },
            { name: 'cloud_platforms', label: 'Cloud Platforms', type: 'tags', placeholder: 'Add cloud platforms...', suggestions: ['AWS', 'Google Cloud', 'Azure', 'DigitalOcean', 'Vercel', 'Netlify', 'Heroku', 'Firebase'] },
            { name: 'technologies', label: 'Technologies', type: 'tags', placeholder: 'Add technologies...', suggestions: ['Git', 'Docker', 'Kubernetes', 'REST API', 'GraphQL', 'WebSocket', 'Redis', 'Elasticsearch'] },
            { name: 'project_type', label: 'Project Type', type: 'tags', placeholder: 'Add project types...', suggestions: ['Web App', 'Mobile App', 'E-commerce', 'API', 'Dashboard', 'Landing Page', 'SaaS', 'MVP'] },
        ],
    },
    {
        id: 'designers',
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., UI/UX Designer' },
            { name: 'design_tools', label: 'Design Tools', type: 'tags', placeholder: 'Add design tools...', suggestions: ['Figma', 'Adobe XD', 'Sketch', 'Photoshop', 'Illustrator', 'InDesign', 'Canva', 'FigJam'] },
            { name: 'design_specialization', label: 'Design Specialization', type: 'tags', placeholder: 'Add specializations...', suggestions: ['UI Design', 'UX Design', 'Graphic Design', 'Product Design', 'Web Design', 'Mobile Design', 'Brand Identity', 'Motion Design'] },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        id: 'writers',
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., Content Writer' },
            { name: 'writing_specialization', label: 'Writing Specialization', type: 'tags', placeholder: 'Add specializations...', suggestions: ['Content Writing', 'Copywriting', 'Blog Writing', 'Technical Writing', 'Creative Writing', 'SEO Writing', 'Social Media', 'Ghostwriting'] },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., Wedding Photographer' },
            { name: 'photography_style', label: 'Photography Style', type: 'tags', placeholder: 'Add styles...', suggestions: ['Portrait', 'Wedding', 'Event', 'Product', 'Fashion', 'Landscape', 'Street', 'Architectural'] },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., Video Editor' },
            { name: 'video_tools', label: 'Video Tools', type: 'tags', placeholder: 'Add tools...', suggestions: ['Premiere Pro', 'After Effects', 'Final Cut Pro', 'DaVinci Resolve', 'CapCut', 'Filmora', 'iMovie', 'Avid Media Composer'] },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., Music Producer' },
            { name: 'music_genres', label: 'Music Genres', type: 'tags', placeholder: 'Add genres...', suggestions: ['Pop', 'Rock', 'Hip Hop', 'Jazz', 'Classical', 'Electronic', 'R&B', 'Country', 'EDM'] },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., Math Tutor' },
            { name: 'subjects', label: 'Subjects', type: 'tags', placeholder: 'Add subjects...', suggestions: ['Mathematics', 'Physics', 'Chemistry', 'Biology', 'English', 'Programming', 'History', 'Economics'] },
            { name: 'teaching_level', label: 'Teaching Level', type: 'tags', placeholder: 'Add levels...', suggestions: ['Beginner', 'Intermediate', 'Advanced', 'High School', 'College', 'University', 'Professional'] },
        ],
    },
    {
        id: 'consultants',
        ...
        fields: [
            { name: 'primary_skills', label: 'Primary Skills', type: 'text', placeholder: 'e.g., Business Consultant' },
            { name: 'consulting_areas', label: 'Consulting Areas', type: 'tags', placeholder: 'Add areas...', suggestions: ['Business Strategy', 'Marketing', 'Finance', 'Operations', 'Human Resources', 'IT Consulting', 'Digital Transformation', 'Startups'] },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
];
...
export default function Create({ user, submitPath, cancelPath }) {
    ...
    const addCategoryTag = (fieldName, e) => {
        if (e.key === 'Enter') {
            ...
            if (input.trim()) {
                const currentTags = data.category_field_tags?.[fieldName] || data.category_fields?.[fieldName] || [];
    ...
    const getCategoryTags = (fieldName) => {
        return data.category_field_tags?.[fieldName] || data.category_fields?.[fieldName] || [];
    };
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-8">
                        ...
                        <p className="mt-2 text-lg text-gray-600 font-medium">
                            Share your skills and start getting hired by amazing clients.
                        </p>
                    </div>
                                            ...
                                            {selectedCategory.fields.map((field) => (
                                                <div key={field.name}>
                                                    ...
                                                    {field.type === 'tags' && (
                                                        <CreatableSelect
                                                            isMulti
                                                            value={(getCategoryTags(field.name) || []).map(v => ({ value: v, label: v }))}
                                                            onChange={(newValue) => {
                                                                const tags = newValue ? newValue.map(v => v.value) : [];
                                                                setData('category_field_tags', {
                                                                    ...data.category_field_tags,
                                                                    [field.name]: tags
                                                                });
                                                            }}
                                                            options={(field.suggestions || []).map(s => ({ value: s, label: s }))}
                                                            placeholder={field.placeholder}
                                                            className="w-full"
                                                            styles={{
                                                                control: (base) => ({
