                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                ...
                                >
                                    ...
                                    <div className="pt-4 border-t border-gray-100">
                                        ...
                                        {formData.categoryCommissions?.length >
                                        0 ? (
                                            <div className="space-y-3">
                                                {formData.categoryCommissions.map(
                                                    (comm, index) => (
                                                        ...
                                                        >
                                                            <span className="w-1/2 text-sm font-medium text-gray-700 capitalize">
                                                                {comm.category}
                                                            </span>
                                                            <input
                                                                type="number"
                                            ...
                                            <p className="text-sm text-gray-500">
                                                No categories found yet. Create
                                                a gig to see categories here.
                                            </p>
                                        )}
                                    </div>
