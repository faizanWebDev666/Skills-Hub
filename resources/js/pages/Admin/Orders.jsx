                ...
                <main className="flex-1 min-w-0">
                    <div className="px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-500 mt-1 text-sm">Track and manage all orders</p>
                        </div>
                                    ...
                                    <tbody>
                                        {orders?.data?.map((order) => (
                                            <tr key={order.id} className="border-b border-gray-100">
                                                ...
                                                <td className="py-4 text-gray-700">{order.gig?.title || 'Service'}</td>
                                                <td className="py-4 text-gray-700">{order.customer?.name || 'Unknown'}</td>
                                                <td className="py-4 text-gray-700">{order.freelancer?.name || 'Unknown'}</td>
                                                <td className="py-4 font-bold text-gray-900">${Number(order.amount).toLocaleString()}</td>
                                                <td className="py-4">
