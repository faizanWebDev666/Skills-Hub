                ...
                <main className="flex-1 min-w-0">
                    <div className="px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">{user.name}'s Wallet</h1>
                                <p className="mt-2 text-gray-600">View transaction history and wallet balance for this user.</p>
                            </div>
                            <Link
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 mb-6">
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-2xl font-bold text-gray-900">{wallet.transactions_count ?? transactions.data.length}</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody className="divide-y divide-gray-200">
                                        {transactions.data.map((transaction) => (
                                            <tr key={transaction.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(transaction.balance_after)}</td>
