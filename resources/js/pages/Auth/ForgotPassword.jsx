                    ...
                    <div className="grid gap-8 lg:gap-10 lg:grid-cols-[1.4fr_1fr] items-center">
                        <div className="rounded-[32px] border border-slate-200/50 bg-slate-100/90 p-6 sm:p-8 lg:p-10 shadow-2xl backdrop-blur-xl order-2 lg:order-1">
                            <div className="max-w-2xl">
                                ...
                                <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-slate-600">
                                    Enter the email address associated with your account and we'll send a secure link to reset your password.
                                </p>
                                ...
                                <div className="mt-6 sm:mt-10 grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-3">
                                    <div className="rounded-3xl border border-slate-200/70 bg-white/95 p-4 sm:p-6">
                                        ...
                                        <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-semibold text-slate-950">Secure</h3>
                                        <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-slate-500">Links expire quickly to keep you safe.</p>
                                    </div>
                                    <div className="rounded-3xl border border-slate-200/70 bg-white/95 p-4 sm:p-6">
                                        <div className="text-2xl sm:text-3xl">✉️</div>
                                        <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-semibold text-slate-950">Fast</h3>
                                        <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-slate-500">Receive a reset link within minutes.</p>
                                    </div>
                                    <div className="rounded-3xl border border-slate-200/70 bg-white/95 p-4 sm:p-6">
                                        <div className="text-2xl sm:text-3xl">⚙️</div>
                                        <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-semibold text-slate-950">Simple</h3>
                                        <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-slate-500">Follow the link and set a new password.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-[32px] border border-white/10 bg-slate-900/95 p-6 sm:p-8 lg:p-10 shadow-2xl backdrop-blur-xl order-1 lg:order-2">
                            <div className="text-center mb-6 sm:mb-8">
                                <h2 className="text-2xl sm:text-3xl font-bold text-white">Recover Account</h2>
                                <p className="mt-2 text-sm sm:text-base text-slate-300">Provide your email and we'll email a reset link.</p>
                            </div>

                            <SocialLogin />

                            <form onSubmit={submit} className="space-y-5 sm:space-y-6 mt-6 sm:mt-8">
                                <div>
