...
export default function Register() {
    ...
    const strengthScore = [hasMinLength, hasUppercase, hasSpecialChar].filter(
        Boolean,
    ).length;
    const strengthLabel =
        strengthScore === 3
                        ...
                        <div className="rounded-[32px] border border-slate-200/50 bg-slate-100/90 p-6 sm:p-8 lg:p-10 shadow-2xl backdrop-blur-xl order-2 lg:order-1">
                            <div className="max-w-xl">
                                ...
                                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-950">
                                    Start hiring or selling services with
                                    confidence.
                                </h1>
                                <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-slate-600">
                                    Whether you want to source expert work or
                                    grow your service business, our platform
                                    connects customers and freelancers with
                                ...
                                <div className="mt-6 sm:mt-10 grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-3">
                                    <div className="rounded-3xl border border-slate-200/70 bg-white/95 p-4 sm:p-6">
                                        ...
                                        <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-slate-500">
                                            Find trusted professionals for every
                                            project.
                                        </p>
                                    </div>
                                    <div className="rounded-3xl border border-slate-200/70 bg-white/95 p-4 sm:p-6">
                                        ...
                                        <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-slate-500">
                                            Showcase skills, set your rates, and
                                            earn more.
                                        </p>
                                    </div>
                                    <div className="rounded-3xl border border-slate-200/70 bg-white/95 p-4 sm:p-6">
                                        ...
                                        <p className="mt-1 sm:mt-2 text-xs sm:text-sm leading-5 sm:leading-6 text-slate-500">
                                            Scale your work with customers who
                                            value quality.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="rounded-[32px] border border-white/10 bg-slate-900/95 p-6 sm:p-8 lg:p-10 shadow-2xl backdrop-blur-xl order-1 lg:order-2">
                            <div className="text-center mb-6 sm:mb-8">
                                ...
                                <p className="mt-2 text-sm sm:text-base text-slate-300">
                                    Sign up and start using the marketplace
                                    today.
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="mt-3 grid grid-cols-3 gap-2">
                                            <div
                                                className={`h-2 rounded-full ${hasMinLength ? "bg-emerald-400" : "bg-slate-700/70"}`}
                                            ></div>
                                            <div
                                                className={`h-2 rounded-full ${hasUppercase ? "bg-emerald-400" : "bg-slate-700/70"}`}
                                            ></div>
                                            <div
                                                className={`h-2 rounded-full ${hasSpecialChar ? "bg-emerald-400" : "bg-slate-700/70"}`}
                                            ></div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
                                        <label
                                            className={`flex cursor-pointer items-center rounded-2xl border p-4 transition ${data.role === "customer" ? "border-brand-500 bg-brand-500/10" : "border-slate-700 bg-slate-950/80 hover:border-slate-500"}`}
                                        >
                                            <input
                                                type="radio"
                                                name="role"
                                        ...
                                        <label
                                            className={`flex cursor-pointer items-center rounded-2xl border p-4 transition ${data.role === "freelancer" ? "border-brand-500 bg-brand-500/10" : "border-slate-700 bg-slate-950/80 hover:border-slate-500"}`}
                                        >
                                            <input
                                                type="radio"
                                                name="role"
                                ...
                                {!isPasswordValid && (
                                    <p className="mt-2 text-sm text-amber-300">
                                        ...
                                        characters, one uppercase letter, and
                                        one special character.
                                    </p>
                                )}
                            </form>
