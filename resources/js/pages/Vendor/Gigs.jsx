                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-t border-gray-100">
                                            ...
                                            <th className="py-3 px-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider hidden sm:table-cell">
                                                Category
                                            </th>
                                            <th className="py-3 px-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                                                Price
                                    ...
                                    <tbody className="divide-y divide-gray-50">
                                        {filteredGigs.map((gig) => (
                                            <tr
                                                key={gig.id}
                                                className={`hover:bg-gray-50 transition-colors ${selectedGigs.includes(gig.id) ? "bg-brand-50/50" : ""}`}
                                            >
                                                <td className="py-3 px-4">
                                                    <input
                                                        type="checkbox"
                                                        checked={selectedGigs.includes(
                                                            gig.id,
                                                        )}
                                                        onChange={() =>
                                                            toggleSelect(gig.id)
                                                ...
                                                <td className="py-3 px-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="min-w-0">
                                                            <Link
                                                                href={`/gigs/${gig.uuid}`}
                                                                className="font-semibold text-gray-900 text-sm hover:text-brand-600 truncate block"
                                                            >
                                                                {gig.title}
                                                            </Link>
                                                ...
                                                <td className="py-3 px-4">
                                                    ...
                                                    >
                                                        <span
                                                            className={`w-1.5 h-1.5 rounded-full ${gig.active ? "bg-success-500" : "bg-gray-400"}`}
                                                        ></span>
                                                        {gig.active
                                                            ? "Active"
                                                            : "Paused"}
                                ...
                                {filteredGigs.length === 0 && (
                                    <div className="text-center py-16 text-gray-400">
                                        ...
                                        <Link
                                            href="/vendor/gigs/create"
                                            className="mt-4 inline-flex items-center gap-2 bg-brand-600 text-white px-5 py-2.5 rounded-xl font-semibold text-sm hover:bg-brand-700 transition-colors"
                                        >
                                            <svg
                                                className="w-4 h-4"
                                                fill="none"
