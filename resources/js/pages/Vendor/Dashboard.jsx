                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                                <div className="max-w-2xl">
                                    ...
                                    <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
                                        Boost your gigs and book more projects.
                                    </h2>
                                    <p className="mt-3 text-sm text-slate-600">
                                        Choose a subscription package that gives
                                        your gigs premium exposure, priority
                                        buyer matching, and higher trust for
                                        faster sales.
                                    </p>
                                </div>
                                <Link
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                                    ...
                                    <p className="mt-2 text-sm text-slate-600">
                                        Featured placement for your top gigs so
                                        buyers discover you quicker.
                                    </p>
                                </div>
                                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                                    ...
                                    <p className="mt-2 text-sm text-slate-600">
                                        Boost trust with badges, promotional
                                        placement, and verified seller support.
                                    </p>
                                </div>
                                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                                    ...
                                    <p className="mt-2 text-sm text-slate-600">
                                        Get matched with active buyers and
                                        receive more requests for your services.
                                    </p>
                                </div>
                            </div>
                        </div>
                                                ...
                                                >
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1">
                                                            ...
                                                            <span
                                                                className={`w-2 h-2 rounded-full ${gig.active ? "bg-success-500" : "bg-gray-400"}`}
                                                            ></span>
