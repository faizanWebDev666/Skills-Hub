...
export default function VendorProfile({ user, profileCompletion }) {
    ...
    const handleRemoveAvatar = () => {
        profileForm.delete(route('vendor.profile.avatar.remove'), {
            preserveScroll: true,
            onSuccess: () => router.reload({ only: ['user', 'profileCompletion'] }),
        });
    };
    ...
    const removePreviousWorkLink = (link) => {
        profileForm.setData('previous_work_links', 
            (profileForm.data.previous_work_links || []).filter(l => l !== link)
        );
    };
    ...
    const handleCertificateUpload = (e) => {
        ...
        if (file) {
            ...
            const interval = setInterval(() => {
                ...
                setUploadProgress(prev => ({ ...prev, certificate: Math.round(progress) }));
            }, 300);
    ...
    const handleRemoveCertificate = (index) => {
        profileForm.delete(route('vendor.profile.certificates.remove', { index }), {
            preserveScroll: true,
            onSuccess: () => router.reload({ only: ['user', 'profileCompletion'] }),
        });
    };
    ...
    const handlePortfolioImageUpload = (e) => {
        ...
        if (file) {
            ...
            const interval = setInterval(() => {
                ...
                setUploadProgress(prev => ({ ...prev, portfolioImage: Math.round(progress) }));
            }, 300);
            ...
            profileForm.post(route('vendor.profile.portfolio.images.upload'), {
                ...
                onSuccess: () => {
                    clearInterval(interval);
                    setUploadProgress(prev => ({ ...prev, portfolioImage: 100 }));
                    setTimeout(() => {
                        if (portfolioImageInputRef.current) portfolioImageInputRef.current.value = '';
                        setUploadProgress(prev => ({ ...prev, portfolioImage: null }));
                        router.reload({ only: ['user', 'profileCompletion'] });
                    }, 500);
                },
                onError: () => {
    ...
    const handleRemovePortfolioImage = (index) => {
        profileForm.delete(route('vendor.profile.portfolio.images.remove', { index }), {
            preserveScroll: true,
            onSuccess: () => router.reload({ only: ['user', 'profileCompletion'] }),
        });
    };
    ...
    const handlePortfolioVideoUpload = (e) => {
        ...
        if (file) {
            ...
            const interval = setInterval(() => {
                ...
                setUploadProgress(prev => ({ ...prev, portfolioVideo: Math.round(progress) }));
            }, 400);
            ...
            profileForm.post(route('vendor.profile.portfolio.videos.upload'), {
                ...
                onSuccess: () => {
                    clearInterval(interval);
                    setUploadProgress(prev => ({ ...prev, portfolioVideo: 100 }));
                    setTimeout(() => {
                        if (portfolioVideoInputRef.current) portfolioVideoInputRef.current.value = '';
                        setUploadProgress(prev => ({ ...prev, portfolioVideo: null }));
                        router.reload({ only: ['user', 'profileCompletion'] });
                    }, 500);
                },
                onError: () => {
    ...
    const handleRemovePortfolioVideo = (index) => {
        profileForm.delete(route('vendor.profile.portfolio.videos.remove', { index }), {
            preserveScroll: true,
            onSuccess: () => router.reload({ only: ['user', 'profileCompletion'] }),
        });
    };
    ...
    const handleResumeUpload = (e) => {
        ...
        if (file) {
            ...
            const interval = setInterval(() => {
                ...
                setUploadProgress(prev => ({ ...prev, resume: Math.round(progress) }));
            }, 300);
                    ...
                    <div className="px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 mb-8">
                            ...
                            <div className="mb-6">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <span className="text-sm font-bold text-brand-600">{profileCompletion}%</span>
                                </div>
                                ...
                                {profileCompletion < 100 && (
                                    <p className="text-xs text-amber-600 font-medium flex items-center gap-1">
                                        ...
                                        Complete more fields to reach 100% profile completion!
                                    </p>
                                )}
                            </div>
                        ...
                        <form onSubmit={handleProfileSubmit}>
                            ...
                            {activeTab === 'professional' && (
                                <div className="bg-white rounded-b-3xl shadow-sm border border-t-0 border-gray-200 p-6 sm:p-8">
                                    ...
                                    <div className="space-y-5">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            <div>
                                                <label className="block text-sm font-semibold text-gray-700 mb-1.5">Professional Title</label>
                                                <input
                                                    type="text"
                                                    value={profileForm.data.professional_title}
                                                    onChange={(e) => profileForm.setData('professional_title', e.target.value)}
                                                    className="w-full px-4 py-2.5 rounded-2xl border border-gray-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 outline-none transition-all text-sm"
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    value={profileForm.data.years_of_experience}
                                                    onChange={(e) => profileForm.setData('years_of_experience', e.target.value)}
                                                    className="w-full px-4 py-2.5 rounded-2xl border border-gray-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 outline-none transition-all text-sm"
                                                >
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    step="0.01"
                                                    min="0"
                                                    value={profileForm.data.hourly_rate}
                                                    onChange={(e) => profileForm.setData('hourly_rate', e.target.value)}
                                                    className="w-full px-4 py-2.5 rounded-2xl border border-gray-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 outline-none transition-all text-sm"
                                                    placeholder="25"
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <input
                                                    type="text"
                                                    value={profileForm.data.delivery_time}
                                                    onChange={(e) => profileForm.setData('delivery_time', e.target.value)}
                                                    className="w-full px-4 py-2.5 rounded-2xl border border-gray-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 outline-none transition-all text-sm"
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    value={profileForm.data.service_type}
                                                    onChange={(e) => profileForm.setData('service_type', e.target.value)}
                                                    className="w-full px-4 py-2.5 rounded-2xl border border-gray-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 outline-none transition-all text-sm"
                                                >
                                                    <option value="">Select...</option>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <input
                                                type="checkbox"
                                                id="vendor_emergency"
                                                checked={profileForm.data.emergency_service}
                                                onChange={(e) => profileForm.setData('emergency_service', e.target.checked)}
                                                className="w-4 h-4 text-brand-600 rounded border-gray-300 focus:ring-brand-500"
                                            />
                                            <label htmlFor="vendor_emergency" className="text-sm font-semibold text-gray-700">Emergency Service Available</label>
                                        </div>
                                                ...
                                                {languagesList.map(lang => (
                                                    <button
                                                        ...
                                                        className={`px-3 py-1.5 rounded-2xl border-2 transition-all duration-200 font-medium text-sm ${
                                                            (profileForm.data.languages || []).includes(lang)
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {daysList.map(day => (
                                                    <button
                                                        ...
                                                        className={`px-3 py-1.5 rounded-2xl border-2 transition-all duration-200 font-medium text-sm ${
                                                            (profileForm.data.available_days || []).includes(day)
                                                                ? 'border-transparent bg-gradient-to-r from-brand-600 to-brand-800 text-white'
                                                                : 'border-gray-200 hover:border-gray-300 text-gray-700'
                                                        }`}
                                                    >
                            ...
                            {activeTab === 'portfolio' && (
                                <div className="bg-white rounded-b-3xl shadow-sm border border-t-0 border-gray-200 p-6 sm:p-8">
                                    <div className="mb-6">
                                        <h2 className="text-lg font-bold text-gray-900">Portfolio & Certifications</h2>
                                    </div>
                                    <div className="space-y-8">
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600 font-semibold">Click to upload certificate</p>
                                            ...
                                            {uploadProgress.certificate !== null && (
                                                <div className="mb-4">
                                                    <div className="flex items-center justify-between mb-2">
                                                        <span className="text-sm font-semibold text-brand-600">Uploading certificate...</span>
                                                        <span className="text-sm font-bold text-brand-600">{uploadProgress.certificate}%</span>
                                                    </div>
                                                            ...
                                                            <div className="aspect-video bg-gray-100 rounded-2xl overflow-hidden border border-gray-200 flex items-center justify-center">
                                                                {cert.endsWith('.pdf') ? (
                                                                    <div className="text-center p-4">
                                                                        <svg className="w-10 h-10 text-red-500 mx-auto mb-2" fill="currentColor" viewBox="0 0 24 24">
                                                                            <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM9 11h6v2H9v-2zm0 4h6v2H9v-2zm0-8h4v2H9V7z"/>
                                                                        </svg>
                                                                        <p className="text-xs text-gray-500 truncate px-2">Certificate {index + 1}</p>
                                                                    </div>
                                                                ) : (
                                                                    <img src={`/storage/${cert}`} alt={`Certificate ${index + 1}`} className="w-full h-full object-cover" />
                                                                )}
                                                            </div>
                                                            <button
                                                                type="button"
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600 font-semibold">Click to upload portfolio image</p>
                                                <div className="mt-2 space-y-1">
                                                    <p className="text-xs text-amber-600 font-medium flex items-center justify-center gap-1">
                                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"/>
                                            ...
                                            {uploadProgress.portfolioImage !== null && (
                                                <div className="mb-4">
                                                    <div className="flex items-center justify-between mb-2">
                                                        <span className="text-sm font-semibold text-brand-600">Uploading portfolio image...</span>
                                                        <span className="text-sm font-bold text-brand-600">{uploadProgress.portfolioImage}%</span>
                                                    </div>
                                                    <div className="w-full bg-gray-100 rounded-full h-2">
                                                        <div 
                                                            className="bg-brand-600 h-2 rounded-full transition-all duration-300"
                                                            style={{ width: `${uploadProgress.portfolioImage}%` }}
                                                        ></div>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            {(user?.portfolio_images || []).length > 0 && (
                                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                                    {(user?.portfolio_images || []).map((image, index) => (
                                                        <div key={index} className="relative group">
                                                            <img src={`/storage/${image}`} alt={`Portfolio ${index + 1}`} className="aspect-square w-full object-cover rounded-2xl border border-gray-200" />
                                                            <button
                                                                type="button"
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600 font-semibold">Click to upload portfolio video</p>
                                                <div className="mt-2 space-y-1">
                                                    <p className="text-xs text-amber-600 font-medium flex items-center justify-center gap-1">
                                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"/>
                                            ...
                                            {uploadProgress.portfolioVideo !== null && (
                                                <div className="mb-4">
                                                    <div className="flex items-center justify-between mb-2">
                                                        <span className="text-sm font-semibold text-brand-600">Uploading portfolio video...</span>
                                                        <span className="text-sm font-bold text-brand-600">{uploadProgress.portfolioVideo}%</span>
                                                    </div>
                                                    <div className="w-full bg-gray-100 rounded-full h-2">
                                                        <div 
                                                            className="bg-brand-600 h-2 rounded-full transition-all duration-300"
                                                            style={{ width: `${uploadProgress.portfolioVideo}%` }}
                                                        ></div>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            <input
                                                ...
                                                className="hidden"
                                            />
                                            {(user?.portfolio_videos || []).length > 0 && (
                                                <div className="space-y-3">
                                                    {(user?.portfolio_videos || []).map((video, index) => (
                                                        <div key={index} className="flex items-center justify-between p-4 bg-cream-100 rounded-2xl border border-gray-200">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div>
                                                                    <p className="font-semibold text-gray-800">Video {index + 1}</p>
                                                                    <p className="text-xs text-gray-500">{video.split('/').pop()}</p>
                                                                </div>
                                                            </div>
                                                            <button
                                                                type="button"
                                                                onClick={() => handleRemovePortfolioVideo(index)}
                                        ...
                                        <div>
                                            ...
                                            {user?.resume_cv ? (
                                                <div className="flex items-center justify-between p-4 bg-cream-100 rounded-2xl border border-gray-200">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-gray-500">{user.resume_cv.split('/').pop()}</p>
                                                        </div>
                                                    </div>
                                                    <div className="flex items-center gap-3">
                                                        <a href={`/storage/${user.resume_cv}`} target="_blank" rel="noreferrer" className="text-brand-600 hover:text-brand-800 font-semibold text-sm">
                                                            View
                                                        </a>
                                                        <button
                                                            type="button"
                                                ...
                                                >
                                                    ...
                                                    <p className="text-gray-600 font-semibold">Click to upload Resume/CV</p>
                                                    <div className="mt-2 space-y-1">
                                                        <p className="text-xs text-amber-600 font-medium flex items-center justify-center gap-1">
                                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"/>
                                            ...
                                            {uploadProgress.resume !== null && (
                                                <div className="mb-4 mt-4">
                                                    <div className="flex items-center justify-between mb-2">
                                                        <span className="text-sm font-semibold text-brand-600">Uploading resume...</span>
                                                        <span className="text-sm font-bold text-brand-600">{uploadProgress.resume}%</span>
                                                    </div>
                                                    <div className="w-full bg-gray-100 rounded-full h-2">
                                                        <div 
                                                            className="bg-brand-600 h-2 rounded-full transition-all duration-300"
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    type="url"
                                                    value={profileForm.data.previous_work_input}
                                                    onChange={(e) => profileForm.setData('previous_work_input', e.target.value)}
                                                    onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addPreviousWorkLink())}
                                            ...
                                            {(user?.previous_work_links || []).length > 0 && (
                                                <div className="mt-3 space-y-2">
                                                    {(user?.previous_work_links || []).map((link, i) => (
                                                        <div key={i} className="flex items-center justify-between px-3 py-2 bg-cream-100 rounded-2xl border border-gray-200">
                                                            <a href={link} target="_blank" rel="noreferrer" className="text-sm text-brand-600 hover:underline truncate">
                                                                {link}
                                                            </a>
                                                            <button
                                                                type="button"
                                                                onClick={() => removePreviousWorkLink(link)}
                                                                className="text-red-500 hover:text-red-700 font-semibold"
                                                            >
                                                                Remove
                                                            </button>
                            ...
                            {activeTab === 'social' && (
                                <div className="bg-white rounded-b-3xl shadow-sm border border-t-0 border-gray-200 p-6 sm:p-8">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-1.5">Behance</label>
                                            <input
                                                type="url"
                                                value={profileForm.data.behance}
                                                onChange={(e) => profileForm.setData('behance', e.target.value)}
                                                className="w-full px-4 py-2.5 rounded-2xl border border-gray-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 outline-none transition-all text-sm"
                                                placeholder="https://behance.net/yourusername"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-1.5">Dribbble</label>
                                            <input
                                                type="url"
                                                value={profileForm.data.dribbble}
                                                onChange={(e) => profileForm.setData('dribbble', e.target.value)}
                                                className="w-full px-4 py-2.5 rounded-2xl border border-gray-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 outline-none transition-all text-sm"
                            ...
                            {(activeTab === 'personal' || activeTab === 'professional' || activeTab === 'social') && (
