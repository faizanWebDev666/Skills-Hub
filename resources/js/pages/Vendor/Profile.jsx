        ...
        <div className="flex flex-col sm:flex-row items-center gap-8">
            <div className="relative w-48 h-48">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <span className="text-sm text-gray-500 font-medium">Total Gigs</span>
                </div>
            </div>
                    ...
                    <div key={index} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-500">
                                {segment.count} gig{segment.count !== 1 ? 's' : ''} ({segment.percentage}%)
                            </p>
                        </div>
                    </div>
                ))}
...
export default function VendorProfile({ user, profileCompletion, categoryDistribution }) {
    ...
    const profileForm = useForm({
        ...
        custom_years_of_experience: user?.custom_years_of_experience || "",
        hourly_rate: user?.hourly_rate || "",
        delivery_time: user?.delivery_time || "",
        available_days: user?.available_days || [],
        service_type: user?.service_type || "",
        custom_service_type: user?.custom_service_type || "",
                            ...
                            <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 mb-8">
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">
                                        Distribution of your gigs across different categories
                                    </p>
                                </div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                            ...
                                            <div>
                                                <SelectWithOther
                                                    ...
                                                    onChange={(val) => profileForm.setData("years_of_experience", val)}
                                                    options={["Less than 1 year", "1-3 years", "3-5 years", "5-10 years", "10+ years"]}
                                                    customValue={profileForm.data.custom_years_of_experience}
                                                    onCustomValueChange={(val) => profileForm.setData("custom_years_of_experience", val)}
                                                />
                                            </div>
                                            <div>
                                                <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                                            ...
                                            <div>
                                                <SelectWithOther
                                                    ...
                                                    onChange={(val) => profileForm.setData("service_type", val)}
                                                    options={["Online", "Offline", "Both"]}
                                                    customValue={profileForm.data.custom_service_type}
                                                    onCustomValueChange={(val) => profileForm.setData("custom_service_type", val)}
                                                />
                                            </div>
                                        </div>
