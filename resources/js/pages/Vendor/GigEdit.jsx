...
const categories = [
    {
        ...
        fields: [
            ...
            { name: 'programming_languages', label: 'Programming Languages', type: 'tags', placeholder: 'Add programming languages...' },
            { name: 'frameworks', label: 'Frameworks', type: 'tags', placeholder: 'Add frameworks...' },
            { name: 'databases', label: 'Databases', type: 'tags', placeholder: 'Add databases...' },
            { name: 'cloud_platforms', label: 'Cloud Platforms', type: 'tags', placeholder: 'Add cloud platforms...' },
            { name: 'technologies', label: 'Technologies', type: 'tags', placeholder: 'Add technologies...' },
            { name: 'project_type', label: 'Project Type', type: 'tags', placeholder: 'Add project types...' },
        ],
    },
    {
        id: 'designers',
        ...
        fields: [
            ...
            { name: 'design_tools', label: 'Design Tools', type: 'tags', placeholder: 'Add design tools...' },
            { name: 'design_specialization', label: 'Design Specialization', type: 'tags', placeholder: 'Add specializations...' },
    ...
    },
    {
        ...
        fields: [
            ...
            { name: 'writing_specialization', label: 'Writing Specialization', type: 'tags', placeholder: 'Add specializations...' },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            ...
            { name: 'photography_style', label: 'Photography Style', type: 'tags', placeholder: 'Add styles...' },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            ...
            { name: 'video_tools', label: 'Video Tools', type: 'tags', placeholder: 'Add tools...' },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            ...
            { name: 'music_genres', label: 'Music Genres', type: 'tags', placeholder: 'Add genres...' },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
    {
        ...
        fields: [
            ...
            { name: 'subjects', label: 'Subjects', type: 'tags', placeholder: 'Add subjects...' },
            { name: 'teaching_level', label: 'Teaching Level', type: 'tags', placeholder: 'Add levels...' },
        ],
    },
    {
        id: 'consultants',
        ...
        fields: [
            ...
            { name: 'consulting_areas', label: 'Consulting Areas', type: 'tags', placeholder: 'Add areas...' },
            { name: 'portfolio_link', label: 'Portfolio Link', type: 'text', placeholder: 'https://yourportfolio.com' },
        ],
    },
];
                                                ...
                                                <div key={field.name}>
                                                    ...
                                                    {field.type === 'tags' && (
                                                        <>
                                                            <input
                                                                type="text"
                                                                onKeyPress={(e) => addCategoryTag(field.name, e)}
                                                                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-4 focus:ring-brand-100 focus:border-brand-500 transition-all"
                                                                placeholder={field.placeholder}
                                                            />
                                                            {getCategoryTags(field.name).length > 0 && (
                                                                <div className="mt-3 flex flex-wrap gap-2">
                                                                    {getCategoryTags(field.name).map((tag, i) => (
                                                                        <span
                                                                            key={i}
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <button
                                                                                type="button"
                                                                                onClick={() => removeCategoryTag(field.name, tag)}
                            ...
                            <div className="space-y-8">
                                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600 font-medium">{gig.image || data.image ? 'Change image' : 'Upload an image'}</p>
                                ...
                                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                                    ...
                                    {data.tags.length > 0 && (
                                        <div className="mt-3 flex flex-wrap gap-2">
                                            {data.tags.map((tag, i) => (
                                                <span key={i} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-brand-100 text-brand-800 font-medium text-sm">
                                                    {tag}
