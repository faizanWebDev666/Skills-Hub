                                                ...
                                                <div className="flex items-start gap-4 flex-1">
                                                    ...
                                                    <div className="min-w-0">
                                                        <div className="flex items-center gap-3 mb-1">
                                                            ...
                                                            <span
                                                                className={`shrink-0 inline-flex px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider ring-1 ${statusColors[order.status] || statusColors.pending}`}
                                                            >
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
                        ...
                        <p className="text-gray-500 text-center mb-8">
                            ...
                            delivered? The customer will be notified to review
