                ...
                <div className="p-4 lg:p-8 w-full max-w-6xl mx-auto mt-16 lg:mt-0">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-500">
                            Manage and reply to reviews from your customers.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-wrap gap-4 mb-8 items-center">
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    handleFilterChange("gig_id", e.target.value)
                                }
                    ...
                    {reviews.data.length > 0 ? (
                        ...
                        <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-100">
                            ...
                            <p className="text-gray-500">
                                You don't have any reviews matching your filters
                                yet.
                            </p>
                        </div>
                    )}
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
                        ...
                        <p className="text-gray-500 text-center mb-8">
                            Are you sure you want to publish this reply? It will
                            be publicly visible to all customers.
                        </p>
