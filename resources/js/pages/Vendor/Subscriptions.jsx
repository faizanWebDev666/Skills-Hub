                    ...
                    <div className="px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
                        ...
                        <div className="mb-8">
                            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                                <div>
                                    <p className="text-sm uppercase tracking-[0.35em] text-brand-600 font-semibold mb-3">
                                        Subscription Plans
                                    </p>
                                    <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900">
                                        Sell faster with premium seller plans.
                                    </h1>
                                    <p className="text-sm sm:text-base text-slate-600 mt-3 max-w-2xl">
                                        Choose the plan that helps you get more
                                        orders, greater visibility, and priority
                                        buyer connections on the marketplace.
                                    </p>
                                </div>
                                <Link
                            ...
                            {plans.map((plan) => (
                                ...
                                >
                                    <div className="flex items-start justify-between gap-4 mb-4">
                                        <div>
                                            <h2
                                                className={`text-xl sm:text-2xl font-semibold ${plan.featured ? "text-slate-900" : "text-slate-900"}`}
                                            >
                                                {plan.name}
                                            </h2>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <p className="text-xs sm:text-sm text-slate-500 mt-2">
                                            One-time upgrade for your gigs
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-3 mb-4 flex-1">
                                        {plan.features.map((feature) => (
                                            ...
                                            >
                                                <span className="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-brand-600 text-white text-xs font-bold">
                                                    ✓
                                                </span>
                                    ...
                                    <button
                                        onClick={async () => {
                                            ...
                                            if (
                                                !confirm(
                                                    `Are you sure you want to ${actionText} ${plan.name} for ${plan.price}?`,
                                                )
                                            )
                                                return;
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                <div>
                                    ...
                                    <p className="mt-3 text-sm text-slate-600">
                                        Subscriptions help your gigs stand out,
                                        capture buyer attention faster, and
                                        increase your order volume through
                                        priority placement and buyer matching.
                                    </p>
                                </div>
                                <div>
                                    <div className="space-y-4">
                                        <div className="rounded-3xl bg-cream-100 p-5">
                                            ...
                                            <p className="text-sm text-slate-600 mt-2">
                                                Your gigs appear above
                                                non-subscribed offers in search
                                                and category feeds.
                                            </p>
                                        </div>
                                        <div className="rounded-3xl bg-cream-100 p-5">
                                            ...
                                            <p className="text-sm text-slate-600 mt-2">
                                                Receive faster buyer requests
                                                through our dedicated vendor
                                                matching system.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div className="space-y-4">
                                        <div className="rounded-3xl bg-cream-100 p-5">
                                            ...
                                            <p className="text-sm text-slate-600 mt-2">
                                                Enjoy priority access to vendor
                                                support and faster approval for
                                                gig updates.
                                            </p>
                                        </div>
                                        <div className="rounded-3xl bg-cream-100 p-5">
                                            ...
                                            <p className="text-sm text-slate-600 mt-2">
                                                Show buyers you’re invested in
                                                growth with a premium seller
                                                badge.
                                            </p>
                                        </div>
                                    </div>
