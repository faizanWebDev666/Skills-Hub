    ...
    return (
        <div className="flex items-center gap-1">
            ...
            {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                    <svg
                        className={`w-8 h-8 transition-colors ${(hover || rating) >= star ? "text-yellow-400" : "text-gray-300"}`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                    >
...
export default function ProfileShow({
    ...
    const confirmCompleteOrder = () => {
        ...
        router.post(
            `/orders/${confirmCompleteModal}/complete`,
            {},
            {
                preserveScroll: true,
                                ...
                                {filteredOrders && filteredOrders.length > 0 ? (
                                    <div className="space-y-4">
                                        {filteredOrders.map((order) => (
                                            <div
                                                key={order.id}
                                                className="p-4 sm:p-5 border border-gray-200 rounded-2xl hover:border-brand-300 transition-colors"
                                            >
                                    ...
                                    <div className="text-center py-12">
                                        ...
                                        <Link
                                            href="/gigs"
                                            className="inline-flex items-center px-6 py-2.5 bg-brand-600 text-white text-sm font-bold rounded-2xl hover:bg-brand-700 transition-colors"
                                        >
                                            Browse Services
                                        </Link>
                                    </div>
                            ...
                            <div className="bg-white rounded-b-3xl shadow-sm border border-t-0 border-gray-200 p-6 sm:p-8">
                                ...
                                {pendingReviews && pendingReviews.length > 0 ? (
                                        ...
                                        {pendingReviews.map((order) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        type="submit"
                                                        className="px-6 py-2.5 bg-brand-600 text-white font-bold text-sm rounded-xl hover:bg-brand-700 transition-colors shadow-sm"
                                                    >
                                                        Submit Review
                                                    </button>
                                                </form>
                                    ...
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-500 mb-4">
                                            You have reviewed all your completed
                                            orders.
                                        </p>
                                    </div>
                                )}
                                ...
                                submittedReviews.length > 0 ? (
                                    <div className="space-y-4">
                                        {submittedReviews.map((review) => (
                                            <div
                                                key={review.id}
                                                className="p-5 border border-gray-200 rounded-2xl bg-slate-50/50"
                                            >
                                                <div className="flex items-start gap-4 mb-3">
                                                    <div className="w-10 h-10 rounded-xl bg-brand-100 flex items-center justify-center shrink-0">
                                                        {review.order?.gig
                                                            ?.image ? (
                                                            <img
                                                                src={`/storage/${review.order.gig.image}`}
                                                                alt={
                                                                    review.order
                                                                        .gig
                                                                        .title
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
                        ...
                        <p className="text-gray-500 text-center mb-8">
                            Are you sure you want to submit this review? It
            ...
            {confirmCompleteModal && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl">
                        ...
                        <p className="text-gray-500 text-center mb-8">
                            Are you sure you want to complete this order? The
                            funds will be released to the freelancer. This
