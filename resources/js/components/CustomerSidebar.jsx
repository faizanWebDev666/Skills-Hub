...
export default function CustomerSidebar({
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed lg:sticky lg:top-[76px] lg:h-[calc(100vh-76px)] lg:overflow-y-auto custom-scrollbar inset-y-0 left-0 z-40 w-72 bg-white pt-20 lg:pt-0 px-0 transform transition-transform duration-300 border-r border-gray-200 lg:min-h-[calc(100vh-76px)] ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}
            >
                {/* User Card */}
                ...
                <div className="mx-4 mt-6">
                    <div className="bg-brand-600 rounded-xl p-5 text-white">
                        ...
                        <Link
                            href="/gigs"
                            className="mt-4 flex items-center justify-center gap-2 w-full bg-white text-brand-700 text-sm font-bold py-2.5 rounded-lg hover:bg-brand-50 transition-colors"
                        >
                            Explore Services
                            <svg
                                className="w-4 h-4"
