        ...
        <nav className="bg-cream-50 shadow-sm sticky top-0 z-50">
            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-3 sm:py-4 max-w-7xl mx-auto">
                    {/* Branding */}
                    <Link href="/vendor/dashboard" className="flex items-center gap-2 flex-shrink-0 hover:opacity-80 transition-opacity">
                        <div className="w-9 sm:w-10 h-9 sm:h-10 bg-brand-50 rounded-lg flex items-center justify-center border border-brand-200">
                            <svg className="w-5 sm:w-6 h-5 sm:h-6 text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                        </div>
                        <span className="text-gray-900 font-bold text-sm sm:text-base hidden sm:block">Vendor Hub</span>
                    </Link>
                            ...
                            {isUserMenuOpen && (
                                <>
                                    ...
                                    <div className="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-xl border border-gray-100 py-1 z-40">
                                        ...
                                        <form method="post" action="/logout" onClick={() => setIsUserMenuOpen(false)}>
