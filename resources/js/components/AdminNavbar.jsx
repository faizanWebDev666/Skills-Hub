            ...
            <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
                <div className="flex justify-between items-center py-3 sm:py-4">
                    <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-8 lg:space-x-12">
                        <Link href="/admin/dashboard" className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
                            ...
                            <span className="text-white font-bold text-sm sm:text-base">Admin Panel</span>
                        </Link>
                        <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
                            <Link href="/admin/dashboard" className="text-red-100 hover:text-white font-medium transition-colors text-sm lg:text-base">
                                Dashboard
                            </Link>
                            <Link href="/admin/users" className="text-red-100 hover:text-white font-medium transition-colors text-sm lg:text-base">
                                Users
                            </Link>
                            <Link href="/admin/gigs" className="text-red-100 hover:text-white font-medium transition-colors text-sm lg:text-base">
                                Gigs
                            </Link>
                            <Link href="/admin/orders" className="text-red-100 hover:text-white font-medium transition-colors text-sm lg:text-base">
                                Orders
                            </Link>
                            <Link href="/admin/reports" className="text-red-100 hover:text-white font-medium transition-colors text-sm lg:text-base">
                                Reports
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-1 lg:space-x-3">
                        ...
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M15 17h5l-5 5v-5zM15 17H9a6 6 0 01-6-6V9a6 6 0 0110.293-4.293L15 6.414V17z" />
                            </svg>
                        </Link>
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <span className="font-medium text-white hidden lg:inline text-sm">{currentUser?.name}</span>
                ...
                <div className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                    <div className="py-4 border-t border-red-500/30">
                        <div className="flex flex-col space-y-3">
                            <Link href="/admin/dashboard" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                Dashboard
                            </Link>
                            <Link href="/admin/users" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                Users
                            </Link>
                            <Link href="/admin/gigs" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                Gigs
                            </Link>
                            <Link href="/admin/orders" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                Orders
                            </Link>
                            <Link href="/admin/reports" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                Reports
                            </Link>
                            ...
                            <div className="pt-4 border-t border-red-500/30 flex flex-col space-y-3">
                                ...
                                <div className="flex items-center gap-3 px-2 py-2">
                                    ...
                                    <span className="font-medium text-white text-sm">{currentUser?.name}</span>
                                </div>

                                <Link href="/admin/profile" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                    Admin Profile
                                </Link>
                                <Link href="/admin/settings" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                    System Settings
                                </Link>
                                <Link href="/admin/logs" className="text-red-100 hover:text-white font-medium py-2 px-1 text-sm">
                                    System Logs
                                </Link>

                                <form method="post" action="/logout">
                                    <input type="hidden" name="_token" value={document.querySelector('meta[name="csrf-token"]')?.content || ''} />
                                    <button type="submit" className="w-full text-left text-red-300 hover:text-red-100 font-medium py-2 px-1 text-sm">
                                        Log Out
                                    </button>
                                </form>
                            </div>
