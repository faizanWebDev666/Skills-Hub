            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-3 sm:py-4 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <Link
                            href="/chat"
                            className="text-gray-600 hover:text-red-600 hover:bg-cream-100 p-2 sm:p-2.5 rounded-lg transition-colors"
                            title="Messages"
                        >
                            <svg
                                className="w-5 h-5"
                        ...
                        <div className="relative">
                            ...
                            >
                                {currentUser?.avatar ? (
                                    ...
                                    <div className="w-8 sm:w-9 h-8 sm:h-9 bg-red-600 rounded-full flex items-center justify-center text-white font-bold text-xs sm:text-sm shrink-0">
