...
export default function WishlistDrawer({ isOpen, onClose }) {
            ...
            {},
            {
                ...
                onSuccess: () => {
                    setWishlistItems((prev) =>
                        prev.filter((item) => item.gig?.uuid !== gigId),
                    );
                },
            },
        );
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div
                className="fixed top-0 right-0 h-full w-full sm:w-[450px] bg-white z-[70] transform transition-transform duration-300 ease-in-out shadow-2xl flex flex-col translate-x-0 pointer-events-auto"
                aria-hidden="false"
                role="dialog"
            >
                ...
                <div className="bg-[#1e3a4c] text-white p-6 flex justify-between items-start">
                    <div>
                        <h2 className="text-2xl font-black uppercase tracking-wider mb-1 font-sans">
                            My Wishlist
                        </h2>
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <Link href={`/gigs/${item.gig.uuid}`}>
                                            <h4 className="font-bold text-gray-900 truncate font-sans">
                                                {item.gig.title}
                                            </h4>
                                        </Link>
