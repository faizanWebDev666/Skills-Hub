...
const sidebarLinks = [
    ...
    { href: '/wallet', label: 'Wallet', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z' },
    { href: '/vendor/reviews', label: 'Reviews', icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' },
    { href: '/vendor/profile', label: 'Profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
];

export default function VendorSidebar({ user, sidebarOpen, setSidebarOpen, conversations = [], totalUnreadMessages = 0 }) {
    const { props } = usePage();
                ...
                <div className="py-6 space-y-6">
                    ...
                    <div className="px-4">
                        <div className="flex items-center gap-3 p-4 bg-brand-50 rounded-xl border border-brand-100">
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="font-semibold text-gray-900 text-sm truncate">{currentUser?.name || 'Vendor'}</p>
                    ...
                    <div>
                        ...
                        <nav className="space-y-0.5 px-2">
                            {sidebarLinks.map((link) => (
                                ...
                                >
                                    <svg className={`w-5 h-5 flex-shrink-0 ${isActive(link.href) ? 'text-brand-600' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="mt-2">
                                ...
                                >
                                    <svg className={`w-5 h-5 flex-shrink-0 ${isActive('/chat') ? 'text-brand-600' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <svg className={`w-4 h-4 text-gray-400 transition-transform ${isMessagesOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            conversations.map((conversation) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="font-medium text-gray-700 truncate">{conversation.other_user?.name}</p>
                    ...
                    <div className="px-4">
                        <div className="bg-brand-600 rounded-xl p-4 text-white">
                            ...
                            <p className="text-xs text-brand-100 mb-3">Get featured listings, priority support & analytics</p>
